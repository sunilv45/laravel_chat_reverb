...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
    <div class="flex overflow-hidden">
        ...
        <div class="flex-1">
            <!-- Chat Header -->
            @if($user)
                <div class="flex-1 p:2 sm:p-0 justify-between flex flex-col h-[45.5rem]">
                    <div class="flex sm:items-center justify-between py-2 border-b-1 border-gray-200">
                       <div class="relative flex items-center space-x-4">
                          <div class="relative">
                             <span class="absolute text-green-500 top-6 left-7">
                    ...
                    <div id="chat-container" class="space-y-4 p-3 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch">
                        @foreach($messages as $message)
                            @if($message['sender'] != auth()->user()->id)
                                <div class="chat-message">
                                    <div class="flex items-end">
                                        <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-2 items-start">
                                            <div><span class="px-4 py-2 rounded-lg inline-block rounded-bl-none bg-gray-300 text-gray-600 text-base">{{ $message['message'] }}</span></div>
                                        </div>
                            ...
                            @else
                                <div class="chat-message">
                                    ...
                                    <div class="flex flex-col space-y-2 text-xs max-w-xs mx-2 order-1 items-end">
                                        <div><span class="px-4 py-2 rounded-lg inline-block rounded-br-none bg-blue-600 text-white text-base">{{ $message['message'] }}</span></div>
                                    </div>
                    ...
                    <div class=" border-gray-200 sm:mb-0">
